...
{
    public byte[] ComputeHash(byte[] bytes) => Sha384Helper.ComputeHash(bytes);

    public byte[] ComputeHash(Stream inputStream) => Sha384Helper.ComputeHash(inputStream);

    public byte[] ComputeHash(string str) => Sha384Helper.ComputeHash(str);

    public string ComputeHashString(byte[] bytes) => Sha384Helper.ComputeHashString(bytes);
